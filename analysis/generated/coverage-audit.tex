...
every & L & L & L & L & 4/1/1 & as the articles; the Mod use after a genitive Det is a separate lexical permission (internal Mod family). \\
...
the general quantifiers & L & L & L & L & 8/1/1 & Det use permission with target restrictions (some: plural or non-count; each: singular count). \\
...
the general quantifiers & D & Dn & D & D & 19/8/0 & some, all, both, each, several, enough independently, and the existential There are several: ordinary Head (I1, I2) or Det–Head fusion (I3, I4). Under I2 the derivation goes through the admission of D as a head of Nom and NP. \\
...
pronouns & D & D & D & D & 11/0/2 & the noun-headed NP without a determiner (She left). \\
...
the gradable four & L & L & L & L & 8/0/0 & grade inflection (few/fewer/fewest): lexical; shared with adjectives. \\
...
common nouns, including quantificational lot, plenty, heaps & D & D & D & D & 13/0/1 & a great deal smaller, lots better, heaps worse, three years old: NP modifiers of adjectives in every account (CGEL pp. 549–550). \\
...
cardinals & S & S & S & S & -- & in threes, in their hundreds: the same rule (I1, I4); CGEL's 'secondary use in which they inflect for number and hence belong in the noun category' is a change of category, a second rule (I2, I3), §5.5. \\
compound determinatives & S & S & S & S & -- & a special someone, such an anyone, the somebodies: the secondary-use rule of §4.5, one rule over Noun (I1, I4); the same rule for nouns plus a conversion rule from D (I2, I3; CGEL p. 423 n. 43), §4.5 and §5.5. \\
proper nouns & S & S & S & S & -- & an Ophelia, the Smiths: CGEL's own secondary use within Noun (p. 521), the same rule in every account. \\
\end{longtable}}
