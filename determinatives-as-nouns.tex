...
Proper names permit nominal premodifiers such as \mention{architect Norman Foster}; \mention{all} in \mention{all we who signed up} is peripheral, rather than an internal pronoun modifier \citep[429--430, 519--520]{huddleston2002}.
...
Separate D with ordinary Head licenses the same structures by admitting N or D. The advantage claimed for D-noun is the correspondence between the lexical grouping and this shared grammar.
