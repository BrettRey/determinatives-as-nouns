...
\begin{table}[H]
\centering\small
\caption{Lexemes with a claim, by diagnostic and subcategory; in parentheses, licensed or conditional / excluded only. Blocks follow the article's argument: the functions and constructional range of §2.1, the nominal connections of §§2.2 and 2.5, the adjectival profile of §2.4, and the structural analysis of §4; within a block, the section's own order. Columns follow Table~2 of the article, with the adjective controls, which lie outside Noun, last.}\label{tab:claim-coverage}
...
\toprule
Diagnostic & common noun & proper noun & pronoun & determ. & adjective (control) & total \\
\midrule
