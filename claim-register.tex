...
\begin{table}[H]
\centering\small
\caption{Lexemes with a claim, by diagnostic and subcategory; in parentheses, licensed or conditional / excluded only.}\label{tab:claim-coverage}
...
\caption{Participation claims by diagnostic and lexeme.}\label{tab:claim-register}\\
\toprule
