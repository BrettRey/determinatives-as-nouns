TASK:
Read this manuscript as a linguist reviewing it for Journal of Linguistics. What is wrong with it, and what would you change? Give your own account of the contribution before evaluating it. Supply up to 800 words. Identify exact passages for consequential findings and generate a concrete alternative for the principal problem. Distinguish manuscript observations from unverified knowledge of the literature. You receive no prior diagnosis or preferred remedy.
