...
Run one bounded audit of the ordinary-Head fragment in `inputs/fragment.tex`. The previous audit's Lean file compiled, but its linguistic encoding was inaccurate. Start afresh from the source and the explicit constraints below. Do not use the previous encoding as your specification.
