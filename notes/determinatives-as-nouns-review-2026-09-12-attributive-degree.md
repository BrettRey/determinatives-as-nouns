...
Section 5.3 incorporates the attested attributive degree modifiers and the comments on noun ones and the some a sequence. The introduction, Table 5, and conclusion no longer assign an automatic cost to NP projection. Trees and schemata are shown as text; footnotes appear beside their paragraphs. [Typeset PDF](../determinatives-as-nouns.pdf) · [Revision record](passes/2026-09-12-attributive-degree.md).
...
Table 3 compares the Head relations across five constructions; §5.2 supplies the rules under both taxonomies.
...
Table 5: Four implementations compared. All retain the lexical and constructional restrictions and adjectival fusion, and must account for attributive nominal degree modifiers. Cardinal and *one* groupings are consequences of the categorization.
...
> Note 18. Payne et al. (2013, 797–98) analyse anaphoric *one* as a common count noun, distinct from determinative *one* and personal pronoun *one*.
