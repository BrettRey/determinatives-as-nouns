...
I adopt the general framework of _The Cambridge grammar of the English language_ (_CGEL_; Huddleston and Pullum (2002)). Unlike _CGEL_, though, I include determinatives within Noun. The claims concern synchronic English lexical categories. {==I treat these categories as language-specific: a classification supported by another language’s grammar doesn’t determine the English classification.==}{>>maybe footnote this?<<}{id="c1" by="user" at="2026-09-10T19:46:19.392Z"}

I use determinative for the category containing articles, demonstratives and quantifiers such as _the_, _this_, _some_, _every_ and _many_. I reserve determiner for {++the++}{id="s2" by="user" at="2026-09-10T19:46:38.850Z"}{--a--}{id="s1" by="user" at="2026-09-10T19:46:37.849Z"} syntactic function within the noun phrase {++characteristically performed by phrases headed by these words++}{id="s3" by="user" at="2026-09-10T19:46:43.100Z"}. This distinction separates what kind of word _some_ is from what syntactic relationships its phrase participates in. Capitalized Noun names the proposed superordinate category containing common nouns, proper nouns, pronouns and determinative nouns.
...
The English article–pronoun boundary has long been contested. Palmer {++(1924)++}{id="s4" by="user" at="2026-09-10T20:01:11.329Z"} groups “determinative adjectives” with pronouns; Postal {++(1966)++}{id="s5" by="user" at="2026-09-10T20:01:17.396Z"} analyses personal pronouns as articles at an intermediate level of representation; Sommerstein {++(1972)++}{id="s8" by="user" at="2026-09-10T20:01:39.468Z"} gives the definite article and pronouns underlying NP structure {--(Palmer 1924; Postal 1966; Sommerstein 1972)--}{id="s7" by="user" at="2026-09-10T20:01:34.454Z"}. Their proposals make different kinds of unification available. Hudson places his determining words within pronoun and pronoun within noun (Hudson 2004, 2010). Section 2.2 compares the English evidence and the resulting classifications.

The motivation is parsimony. First, including determinative within Noun removes a separate primary lexical category and its phrasal projection, replacing DP with NP. Second, it gives independent determinatives ordinary Head structure in the NP, unifying the bare, partitive and externally determined uses that _CGEL_ divides between Det–Head and Mod–Head fusion. {==Third==}{>>really, only 3?<<}{id="c2" by="user" at="2026-09-10T20:03:18.807Z"}, it brings the determinative, common-noun and proper-noun uses of cardinals within one primary category. Section 7 compares these reductions with the changes required in stating modifier and use restrictions.
...
| Relation among Noun, pronoun and determinative | {==Account==}{>>can we not have a cell for each other accounts above (Postal, etc.)?<<}{id="c8" by="user" at="2026-09-10T20:57:08.108Z"} or status |
| :--- | :--- |
...
| {++Pronoun is within proper noun and determinatives is withing common noun, etc.++}{id="s9" by="user" at="2026-09-10T20:06:38.781Z"} | {++An unlikely and unclaimed logical comparison++}{id="s10" by="user" at="2026-09-10T20:07:59.118Z"} |
...
Sommerstein (1972, 197–203) argues in the opposite direction, giving the definite article and personal pronouns underlying NP structure. His English comparison includes the count restriction on pro-nominal _one_ {++(but see the CGEL-team paper on _one_)++}{id="s11" by="user" at="2026-09-10T20:10:25.158Z"}, which contrasts with _it_’s ability to refer to a quantity of a substance. He also observes that noun status for _self_ doesn’t decide whether the preceding element is an article or a genitive pronoun. Their disagreement concerns which direction of analysis explains the shared behaviour.
...
The comparison therefore concerns the same English words across external syntax, internal syntax, semantics, inflection{++,++}{id="s15" by="user" at="2026-09-10T20:16:56.472Z"} and word formation. Independent use and shared deixis supply part of that evidence. Grade, genitive marking, complementation, modifier selection and derivational relationships supply further comparisons, including potential evidence against unification. Section 3 sets out this broader profile before §4 develops the nominal constructions and §5 assesses the pronoun boundary.
# 3 The D-noun analysis
## 3.1 The existing standard of nounhood
The starting category is Noun as _CGEL_ already constitutes it. Pronouns differ from prototypical nouns in inflection and permitted dependents, but qualify because their phrases have nearly the same range of syntactic functions as common- and proper-noun-headed phrases, including subject, object and determiner (Huddleston and Pullum 2002, 327). Table 2 compares this external overlap with the internal, semantic and morphological variation already accepted within Noun and the proposed determinative extension.

Table 2: Representative profiles of the three existing noun subcategories and the proposed fourth. Entries describe ranges of behaviour, not properties of every member. External syntax concerns the phrases containing the relevant words; the competing analyses differ over their internal heads. Sources and qualifications are developed in the text.

| Dimension | Common noun | Proper noun | Pronoun | Determinative |
| :--- | :--- | :--- | :--- | :--- |
| Inventory | Open | Open to new names | Closed | Closed |
| External syntax | NP argument functions; genitive Det | NP argument functions; genitive Det | NP argument functions; genitive Det | NP argument functions; {==plain and restricted genitive Det==}{>>what does this mean?<<}{id="c3" by="user" at="2026-09-10T20:19:11.732Z"} |
| Meaning | Descriptive properties and relations{++; categories used by pro-form gender++}{id="s17" by="user" at="2026-09-10T20:29:54.063Z"} | Naming in primary uses{++; categories used by pro-form gend++}{id="s18" by="user" at="2026-09-10T20:30:40.365Z"} | Mainly deixis and anaphora{++; pro-form gender++}{id="s19" by="user" at="2026-09-10T20:31:01.211Z"} | Quantification, definiteness and deixis{++; pro-form gender++}{id="s20" by="user" at="2026-09-10T20:31:14.346Z"} |
| Inflection | Number and genitive | Genitive; restricted number | Case; {++genitive;++}{id="s16" by="user" at="2026-09-10T20:23:15.625Z"} {==reflexive number==}{>>what does this mean?<<}{id="c4" by="user" at="2026-09-10T20:22:55.504Z"}{>>is this reflexive; number?<<}{id="c5" by="user" at="2026-09-10T20:28:38.632Z" re="c4"} | Number; grade; genitive, e.g. _something’s_ |
| {==Word formation==}{>>what we're looking for here is specific affixes that are probative, that either attach to or form common nouns exclusively (at least exclusive of any other category but possibly proper, pro-, and D-nouns)<<}{id="c6" by="user" at="2026-09-10T20:32:38.826Z"} | Affixation and compounding: _friendship_ | Affixation and compounding: _Londoner_ | Gender-marking compounds: _he-goat_ | Compounding and outward derivation: _nothingness_, _mostly_ |
...
| Internal modification | Productive; usually AdjP premodifiers{++; relative postmodifiers++}{id="s21" by="user" at="2026-09-10T20:46:15.449Z"} | Restricted embellishments | Restricted: _poor old me_; {--integrated--}{id="s22" by="user" at="2026-09-10T20:46:32.742Z"} relative {++postmodifier++}{id="s23" by="user" at="2026-09-10T20:46:34.909Z"}s | AdvP premodifiers; NP-internal postmodifiers; _the lucky few_ |
| Complemen­tation | Selected PPs and clauses | Not characteristic of primary naming uses | Normally absent | Partitive _of_-PPs; comparative _than_-phrases |
...
External distribution alone {==is insufficient==}{>>though CGEL treats it as if it were in allowing pronouns into the Noun category; nevertheless, I reject this kind of essentialism<<}{id="c7" by="user" at="2026-09-10T20:52:52.298Z"}: adjectival constructions such as _the rich_ also fill those positions. The internal comparison includes determination, modification and complementation. Common nouns select PPs and clauses, whereas pronouns and primary naming uses of proper nouns have much more restricted dependents (Huddleston and Pullum 2002, 429–30, 439–43, 517–21). Determinatives permit partitive complements, as in _some of the wine_, and comparative complements, as in _more than ten_ (Huddleston and Pullum 2002, 392–94, 411–12, 432–33). These permissions require lexical and constructional specification under either taxonomy.

Inflection supplies overlapping contrasts too. Common nouns inflect for number and genitive; proper nouns also permit number distinctions in restricted uses. Pronouns have case contrasts and number inflection in reflexives. Within determinative, _this_/_these_ shows number, _few_/_fewer_/_fewest_ grade, and _something’s_ genitive (Huddleston and Pullum 2002, 373, 423–24, 426, 479–80, 521). Number and case connect parts of the inventory with nouns; grade connects another part with adjectives. Word formation adds further evidence of both kinds (§3.4).
...
The inherited projection gives the two D-noun structures in Figure 1. In _take some apples_, the NP headed by _some_ fills Det, as _Kim’s_ does in _Kim’s preferences_; _apples_ heads the larger NP. In _take some_, _some_ heads the whole object NP. The lexeme retains its subcategory and nominal projection across these uses, while the NP it heads changes function.

Shared projection doesn’t imply unrestricted interchangeability. The determiner construction selects a determinative-headed phrase, a suitable genitive NP, or another licensed expression. {++But this centralizes the realization of the determiner function among NPs. Even the non-standard determiner **_what size_** _shoes_ is++}{id="s24" by="user" at="2026-09-10T22:46:43.416Z"} {++also an NP. This leaves a very small number of possible non-NPs (e.g., the PP++}{id="s25" by="user" at="2026-09-10T22:48:30.473Z"} {++**_almost ten_**++}{id="s25" by="user" at="2026-09-10T22:48:30.473Z"}{>><<}{id="c9" by="user" at="2026-09-10T22:49:37.553Z"} {++_hours_) as non-NP determiners.++}{id="s25" by="user" at="2026-09-10T22:48:30.473Z"} Number, countability and other selectional conditions further distinguish the determining expressions. Section 7.2 includes these restrictions in the comparison of grammars.
...
The existing noun subcategories also differ in the range and conditions of their postmodifiers. Common nouns freely take integrated relative clauses; personal pronouns permit a restricted range, including _we who have read the report_ (Huddleston and Pullum 2002, 430). Compound determinatives permit them too, as in _something that you need to know_ (Huddleston and Pullum 2002, 423–24). These comparisons show that modifier permissions can vary within Noun, but they don’t neutralize the premodifier objection.

Including determinatives requires stating the usual premodifier contrast below primary Noun. The determinative subcategory licenses _hardly any_ and _almost every_; common nouns license _experienced teacher_. Neither *_experienced every_ nor *_almost teacher_ follows. This preserves the judgments, but preservation alone doesn’t favour the reclassification. Shared nominal structure elsewhere has to justify locating this contrast at subcategory level. Section 7.3 weighs that cost against the projection rules in §7.2.
## 3.4 Word formation and category boundaries
Determinatives participate in word formation both as components of compounds and as potential bases for derivatives in other categories. _CGEL_ explicitly cites _nothingness_ and _oneness_ among formations with _-ness_ on non-adjectival bases (Huddleston and Pullum 2002, Ch. 19, §5.7.2(i)). Further established nouns include _thisness_, _fewness_ and _muchness_; the adverb _mostly_ is related to _most_ by _-ly_. These relationships extend beyond the formation of determinatives themselves.

> Note 3. See _Merriam-Webster.com Dictionary_, s.vv. [_thisness_](https://www.merriam-webster.com/dictionary/thisness) and [_fewness_](https://www.merriam-webster.com/dictionary/fewness), and _Dictionary.com_, s.vv. [_muchness_](https://www.dictionary.com/browse/muchness) and [_mostly_](https://www.dictionary.com/browse/mostly) (accessed 10 September 2026). _Thisness_ is a philosophical term; _muchness_ has restricted senses and uses. The entries establish the words and document their meanings or histories; they don’t establish a uniformly productive modern rule.

The suffixes suggest an adjectival affinity worth testing. The default suffix for forming nouns from adjectives is _-ness_, and adverbial _-ly_ likewise primarily attaches to adjectives. Neither is exclusively adjective-selecting: _CGEL_ gives the non-adjectival _-ness_ bases just mentioned and noun-based adverbs such as _partly_ and _purposely_ (Huddleston and Pullum 2002, 566; Ch. 19, §5.7.2(i)). Thus the derivatives are compatible with several base classifications. Their evidential force depends on the suffix’s input range and the relevant sense of the base.

This comparison distinguishes derivation from the category of its output. On a direct D-base analysis, _nothingness_ maps determinative to common noun; the D-noun proposal places that change within Noun. _Mostly_ maps its base to adverb, crossing a primary-category boundary under either taxonomy. Where an independently motivated converted base intervenes, the derivation begins from that base instead. A converted noun shouldn’t be posited solely to protect a preferred classification of D.

Compounding supplies another comparison. Common and proper nouns readily form compounds and derivatives such as _friendship_ and _Londoner_; pronouns enter the gender-marking compounds _he-goat_ and _she-ass_ (Huddleston and Pullum 2002, Ch. 19, §§5.3, 5.6.2(b), 5.7.2(k)). Determinative bases combine with nominal material in _someone_ and _anything_, and their premodifier permissions recur in the compounds (§4.5). A closed lexical inventory can therefore participate in word formation, though the processes and their productivity differ among the subclasses.

Numeral morphology extends the comparison to further outputs. Cardinal bases enter ordinal and fractional formations, analysed respectively as adjectival and nominal by Reynolds (2026). Their formation also supplies evidence about the boundary between a numeral lexeme and a syntactic phrase. That constituency question is separate from whether a cardinal base belongs within Noun. The broader inventory includes both numeral and nonnumeral derivations, whose input restrictions need to be represented under either classification.

Morphology contributes a mixed profile. Number and genitive connect determinatives with existing nouns, while grade and the predominantly adjectival _-ness_ and _-ly_ patterns connect some members with adjectives. These processes cut across the proposed subcategories in different ways. The D-noun analysis preserves their separate input restrictions; the positive case for its superordinate grouping rests chiefly on the recurring nominal constructions examined next.
...
The systematic premodifier contrast in §3.3 identifies an additional cost. A restriction normally stated for primary Noun now applies to specified noun subcategories, while determinative nouns retain their adverbial premodifiers. The attributive _almost textbook_ exception limits the original generalization but doesn’t erase that change. In compounds, inherited premodifier permissions also remain distinct from the post-head restrictor construction (§4.5). Economy therefore depends on the shared projection compensating for this less general statement of modifier selection.
