...
Revised after the author comments through §2.1 and the editorial scar-tissue pass. Trees and schemata are shown as text; footnotes appear beside their paragraphs. The LaTeX source remains the manuscript master. [Typeset PDF](../determinatives-as-nouns.pdf).
# Abstract
...
{~~In~>It's worth stating explicitly that, in~~}{id="s1" by="user" at="2026-09-10T14:01:37.160Z"} the D-noun analysis, determinatives inherit the nominal projection rules of Noun. A determinative heads a nominal (Nom), which heads an NP. Nom contains the head and its internal dependents, excluding an external determiner. Lexical restrictions govern which uses are available. {~~The placement of determinative alongside pronoun is a further proposal, assessed in §5~>This flows from treating determinatives as nouns, but contrasts with _CGEL_'s fusion-of-functions proposal, which is at best niche, selective, and contested, with low theoretical adoption~~}{id="s3" by="user" at="2026-09-10T14:02:45.750Z"}{==.==}{>>see '/Users/brettreynolds/Downloads/deep-research-report(30).md'<<}{id="c1" by="user" at="2026-09-10T14:28:53.465Z"}

Figure 1 compares _CGEL_ with the D-noun analysis for _take some apples_ and _take some_. Both keep _some_ in one lexical category across uses. In _CGEL_, independent _some_ jointly fills determiner and head functions, a fusion of functions (Huddleston and Pullum 2002, 410–12). In the D-noun analysis, _some_ heads its own NP through a Nom in both uses.

Here DP abbreviates determinative phrase, as in _CGEL_{++,++}{id="s7" by="user" at="2026-09-10T14:32:07.268Z"}{--.--}{id="s6" by="user" at="2026-09-10T14:32:05.241Z"} {--It differs from--}{id="s5" by="user" at="2026-09-10T14:32:04.207Z"} {++not to be confused with++}{id="s8" by="user" at="2026-09-10T14:32:12.256Z"} the DP of the DP hypothesis, where D heads the whole expression _some apples_ (Abney 1987).{++[see below]++}{id="s9" by="user" at="2026-09-10T14:32:40.739Z"} The D-noun analysis keeps _apples_ as that expression’s ultimate head.
...
{++⁠⁠The placement of determinative alongside, rather than with, pronoun is++}{id="s4" by="user" at="2026-09-10T14:03:58.131Z"} {++a further proposal++}{id="s4" by="user" at="2026-09-10T14:03:58.131Z"}{>>but even this wording seems silly. If I'm not arguing for this as the central idea, then I'm just recapitulating the earlier proposals.<<}{id="c2" by="user" at="2026-09-10T14:34:05.851Z"}{++, assessed in §5. (or maybe this isn't the right place either)++}{id="s4" by="user" at="2026-09-10T14:03:58.131Z"}
...
{++⁠The motivation for this proposal is the principle of parsimony or Occam's razor. I argue that the D-noun analysis requires fewer stipulations and less machinery than the existing _CGEL_ account. It reduces the number of major lexical categories by one, ... Complete the list.++}{id="s10" by="user" at="2026-09-10T14:41:08.441Z"}
...
The compound determinative joins this pattern in _someone’s book_: its genitive NP fills the same determiner function. The nominal base in _someone_ may contribute to that permission; it doesn’t establish genitive marking throughout determinative.
...
A grammar with Hudson’s nested classification can use the same permissions and projection rules. Holding those rules fixed, an added pronoun category between Noun and determinative leaves the fragment’s judgments unchanged. Agreement on these judgments leaves the broader pronoun category open.
