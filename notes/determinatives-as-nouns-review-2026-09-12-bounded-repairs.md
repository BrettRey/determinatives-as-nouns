...
Bounded repairs retain the modifier analysis, clarify the compound constituency contrast and independent-genitive agreement, distinguish relative postmodification from clause-internal grammar, and remove the unsupported fusion-uptake claim. Trees and schemata are shown as text; footnotes appear beside their paragraphs. [Typeset PDF](../determinatives-as-nouns.pdf) · [Response to all review points](passes/2026-09-12-bounded-repairs.md).
...
> Note 3. Payne et al. (2013, 797–98) analyse anaphoric *one* as a common count noun, distinct from determinative *one* and personal pronoun *one*.
...
> Note 4. Whether independent *what* and relative *which* belong to pronoun or determinative leaves them within the proposed Noun category. I leave that internal boundary open here; *CGEL*’s inventory suffices for the present comparison (Huddleston and Pullum 2002, 397–99).
...
A grammatical fragment is a set of rules for a specified range of constructions. Here it covers determination, ordinary subject and object uses, partitives, and the modifier and compound comparisons in §4. It compares the D-noun analysis with two separate-D alternatives: ordinary headedness and fusion. All receive the same lexical restrictions and constructed judgments. The fragment admits relative clauses as postmodifiers but doesn’t analyse their internal grammar.

Predication, interrogative clause structure, and modification outside NP structure also fall outside its scope; their implications enter the broader comparison in §7.3.
