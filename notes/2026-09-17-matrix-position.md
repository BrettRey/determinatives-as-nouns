...
The articles are not isolated in the matrix: they sit with *every*, *no*, determinative *such* (*such contract as may be executed*, *such books as these*), interrogative determinative *what* (*what book*, the row `what_det`) and the *which* determinatives in a cluster defined by dependent-only use, and determinative *such* is *the*'s nearest neighbour. These are not the adjectives *CGEL* names at p. 435, degree *such* and exclamative *what* of *such a disaster* and *what a disaster*, which are different lexemes with the same spelling; a first version of this note conflated them (corrected by Brett, 2026-09-17). The cluster is therefore all determinative, and the 2021 evidence for the articles' coherence with the other dependent-only determinatives stands as stated. The four gradable quantifiers sit inside the general quantifier cluster with *some*, *all*, *any*, *enough*, *several*; their adjectival profile is visible only in that their grade forms (*fewer*, *fewest*, *more*, *most*, *less*, *least*) are their own nearest neighbours. Nothing in the matrix separates them from the other quantifiers, and nothing in it could, since adjectives were not coded.
