...
Brett Reynolds — 12 September 2026 working draft

Section 2.3 adds quantificational controls, a construction matrix, and sourced examples. The proposed cline concerns dependence on overt nominal support; its ordering remains to be tested. Sections 2.1 and 2.6 connect the comparison to the main argument. Trees and schemata are shown as text; footnotes appear beside their paragraphs. [Typeset PDF](../determinatives-as-nouns.pdf) · [Revision record](passes/2026-09-12-quantifier-controls.md).
...
Category membership doesn’t remove lexical restrictions, such as the one applying to *every*. *Every apple* is grammatical, but unlike *some* in *I’ll take some*, *every* can’t occur independently in \**I’ll take every*. The rules in §5.2 retain that restriction.

NPs already modify adjectives in *a great deal better* and *heaps worse* (Huddleston and Pullum 2002, 549–50). Attested attributive *heaps better* also challenges a general exclusion of NP modifiers from attributive adjective phrases (AdjPs). Degree uses thus extend the comparison with quantificational common nouns; their actual restrictions must be distinguished before NP projection can be counted as an added cost (§5.3).
...
Compound determinatives also take post-head adjectives. CGELBank, a treebank annotated in the *CGEL* framework (Reynolds et al. 2023), attests *I need something reliable and good looking*. The position and interpretation of these modifiers have specialized conditions (§4.5).

> Note 7. Sentence [`answers-20111024111513AAAQhAO_ans-0003`](https://github.com/nert-nlp/cgel/blob/d0a2c2d8c522b23d5aa879fc9cb94948f4285b2c/datasets/ewt-test_iaa50.cgel#L179-L181) in `ewt-test_iaa50.cgel`.
...
Table 2: Independent quantificational uses. G: described in *CGEL*; R: restricted there; I: constructed positive illustration in the stated frame. Numbered references identify attestations below. A question mark marks an unresolved cell, not an ungrammaticality judgment.
...
> Note 9. Thomas Hughson, [“Interpreting Vatican II: ‘A New Pentecost’”](https://theologicalstudies.net/wp-content/uploads/2022/08/69.1.1.pdf#page=7), *Theological Studies* 69 (2008), p. 9; COCA academic record, checked against the journal PDF. The NP is object of *irradiate*.

(2b) *numerous of its inhabitants*

> Note 10. Norman Harrington, *New York Times*, 7 April 1968, as quoted in *Merriam-Webster’s Dictionary of English Usage* and reproduced in Reynolds and Pullum’s [“New members of closed classes in English”](https://www.lel.ed.ac.uk/~gpullum/ClosedClasses.pdf), §2.1.2. Verified through that draft; the newspaper original wasn’t checked.

(2c) *multiple of the fast casual eateries*

> Note 11. COCA, 2012 blog discussion under [“BurgerFi Bringing Its Burgers to…”](http://www.tonetoatl.com/2012/08/burgerfi-bringing-its-burgers-to.html). The surrounding phrase is *in front of multiple of the fast casual eateries*. Expanded corpus context and source metadata checked; the original page wasn’t available.

(2d) *numerous were injured*

> Note 12. [Page Six](https://pagesix.com/2022/07/04/travis-scott-performs-in-miami-at-e11even/), 4 July 2022; NOW expanded context. The clause follows a coordinated clause about people who died. Here *numerous* is the canonical subject.

(2e) *multiple were injured*

> Note 13. Ivana Saric and Herb Scribner, [Axios](https://www.axios.com/2022/06/27/amtrak-train-derail-missouri), 27 June 2022, opening sentence; original page checked.

Existentials show a further range in (3). In (3a), *multiple* ends the question, with wedding dresses under discussion. The next two examples contain partitives. The remaining examples have relative postmodifiers and include published prose, a hearing transcript, and reported speech. Source locations identify the records; they don’t establish each speaker’s or writer’s variety.

(3a) *are there multiple?*

> Note 14. Kira Bindrim, in a [Quartz podcast transcript](https://qz.com/india/2130303/the-big-fat-indian-wedding-is-only-getting-bigger), 2022; NOW and original transcript. The preceding question introduces wedding dresses. NOW dates the record 22 February; the current page reports an update on 20 July.

(3b) *there are multiple of them*

> Note 15. Ivan Mehta, [TechCrunch](https://techcrunch.com/2022/09/16/ios-16-users-are-getting-creative-with-the-new-background-removal-feature-for-photos/), 16 September 2022; NOW and original article. The antecedent is objects in a photo.

(3c) *There are countless of them out there*

> Note 16. [“Facebook’s Future Is Brighter Than Ever”](https://seekingalpha.com/article/4349886-facebooks-future-is-brighter-ever), Seeking Alpha, 25 May 2020; NOW expanded context and source metadata. The antecedent is payment apps.

(3d) *There are multiple that are cited in my response.*

> Note 17. Zachary Loyed, public-records hearing, *State of Florida v. Thomas Lee Gudinas*, 29 May 2025, transcript p. 7, lines 14–15; [Appendix C](https://www.supremecourt.gov/DocketPDF/24/24-7457/363457/20250618100158557_Appendix%20to%20the%20Petition%20for%20Writ%20of%20Certiorari-06-18-25.pdf), PDF p. 55. Original transcript checked; *multiple* refers to cases.

(3e) *There are countless who have greatly impacted their communities*

> Note 18. [“The Sisterhood List”](https://metro.co.uk/2023/10/01/the-sisterhood-list-saluting-the-uk-black-women-whove-opened-doors-for-others-19558944/), Metro, 1 October 2023; NOW expanded context and source metadata.

(3f) *there are numerous who are willing to donate*

> Note 19. Nana Patekar, as quoted in English by IANS in [The Indian Express](https://indianexpress.com/article/entertainment/bollywood/nana-patekars-foundation-collects-rs-80-lakh-for-drought-hit-farmers/), 19 September 2015; NOW and original article. The original language of the speech wasn’t established.

(3g) *there are certain who would not like* …

> Note 20. Donald Trump, as quoted in [Fox News](https://www.foxnews.com/politics/trump-throws-support-behind-coronavirus-stimulus-bill-in-senate-vows-to-sign-vital-legislation-immediately), 25 March 2020; NOW record dated 26 March and original article. The quotation was checked against the article, without an audio check.
...
Degree *very* selects gradable heads: *very tall* and *very few*, but \**very you*, \**very the book*, and \**very my life*. It also excludes non-gradable determinatives: \**very every*, \**very some*, and \**very this*. The associated series includes *so few*, *too few*, *how few*, and *as few as*. These degree patterns select *few*, *many*, *much*, and *little*, the four determinatives that inflect for grade (Huddleston and Pullum 2002, 393–95, 431–32).
...
> Note 23. Whether independent *what* and relative *which* belong to pronoun or determinative leaves them within the proposed Noun category. I leave that internal boundary open here; *CGEL*’s inventory suffices for the present comparison (Huddleston and Pullum 2002, 397–99).
...
| Internal modification | Productive AdjP and nominal premodifiers; relative postmodifiers | Restricted AdjP premodifiers and embellishments | Restricted AdjP premodifiers and relative postmodifiers | Degree AdvP on four quantifiers; NP modifiers; *the lucky few*; relatives |
...
| Peripheral AdvP | *only the book* | *even Kim* | *only you* | *almost every*; *hardly any*; *almost ten* |
...
> Note 25. CGELBank (Reynolds et al. 2023), sentence [`reviews-083459-0002`](https://github.com/nert-nlp/cgel/blob/d0a2c2d8c522b23d5aa879fc9cb94948f4285b2c/datasets/ewt.cgel#L651-L654).

\(4\) *Went there yesterday: we are trying to decide between two different Honda models, so we wanted to test-drive both back to back.*
...
Table 4 compares the Head relations across five constructions; §5.2 supplies the rules under both taxonomies.
...
> Note 26. Compare the theory of second best in Lipsey and Lancaster (1956, 11–12): under a constraint preventing an optimum, satisfying more optimality conditions needn’t improve the outcome. The analogy concerns interactions among grammatical choices, not a formal optimum for the grammar.
...
Approximatives need internal attachment where they follow an external determiner on an independent cardinal: *the almost thirty who came*. The internal AdvP permissions at issue are thus the degree series on *few*, *many*, *much*, and *little* across dependent and independent uses, and approximatives on externally determined independent cardinals.
...
The same division applies to *someone* and *everybody*: the compound construction licenses the post-head restrictor, while the determinative base supplies its premodifier permissions. The attested *something reliable and good looking* illustrates the post-head pattern (§2.1).
...
A grammatical fragment states rules for a specified range of constructions. The four accounts receive the same judgments and lexical restrictions. Comparing the rules needed for coverage makes their commitments explicit; it doesn’t test them against new data.

## 5.1 Scope and use permissions

The fragment covers determination, ordinary subject and object uses, partitives, and the modifier and compound comparisons in §4. It admits relative clauses as postmodifiers but doesn’t analyse their internal grammar. Predication, interrogative clause structure, and modification outside NP structure lie beyond its scope. Degree uses enter the wider accounting in §5.3.

Table 5 records use permissions. Dependent means that the form heads a phrase in Det function before another nominal. Independent means that its phrase occurs without another nominal in the displayed subject or object uses, as in *Some left* and *I saw some*. These labels describe the constructions covered here, rather than every possible function. Quotation, metalinguistic naming, and subordinate-clause uses of dependent genitives fall outside the fragment. Noun membership doesn’t itself grant a use permission.

Table 5: Shared permissions in the fragment. For *some*, the target column concerns its unstressed use before a noun. The inventory is deliberately limited to the displayed constructions.
...
The reciprocal selection facts are substantial: a singular count noun normally requires determination, while *every* requires an overt nominal and *some* doesn’t. They establish conditions in both directions. The noun can remain Head while both constituents impose these conditions.

## 5.2 Shared phrase types and projection rules

In *some apples* and *Kim’s apples*, the determining phrases share the NP category under the proposed package. Separate D can permit the same NP projection. For the D-noun/fusion alternative, I retain that projection and add fusion in independent uses. These three implementations therefore share an inventory of phrase types. *CGEL* instead distinguishes DP from genitive NP.

*CGEL* also admits a restricted range of plain-case NPs and PPs as determiners, as in *what size hat* and *over thirty ties* (Huddleston and Pullum 2002, Ch. 5, §4). The phrase types are:

```text
CGEL:  Det:{DP,NP,PP}
The three NP-projecting accounts:  Det:{NP,PP}
```

Determinative phrases and genitive NPs supply the principal realizations in *CGEL*; PPs are restricted. Giving determinatives NP projection consolidates those principal types. Determinative-headed, genitive, and other licensed NPs still require separate identification. *CGEL* already states definiteness and the single-Det restriction functionally, so recategorization doesn’t derive them. The following fragment compares Head relations with those restrictions held fixed.

The four combinations permit comparison of the Head analyses within each taxonomy and of the taxonomies under each Head analysis. Table 6 summarizes their commitments. The implementations below specify the phrase types as well as the lexical categories and Head functions.

The D-noun analysis applies nominal projection to determinatives through their membership in Noun. A separate condition checks use permissions. In the schemata below, `h` identifies the lexical head throughout its projection; parentheses mark optional dependents. The head’s entry and construction restrict every dependent. `Mod_periph` adds the peripheral premodifier discussed in §4.4; the compact rule leaves further NP layering implicit.

`Mods_post` denotes a possibly empty, constructionally ordered sequence of postmodifiers. For compounds, this permits one specialized restrictor followed by ordinary postmodifiers: *useful* precedes *that I found* in *something useful that I found*. It doesn’t permit unrestricted repetition of the restrictor. The same sequence notation and ordering conditions apply under all four accounts.
...
*Some* and *few* permit a partitive *of*-phrase within their nominal projection. Independent *few* permits definite determination in *the few* and optional adjectival modification in *the lucky few*. Degree *very* modifies *few* internally across dependent and independent uses.

Peripheral *almost* modifies the NP headed by *every*; this doesn’t license *experienced* as its modifier. The cardinal construction *the almost thirty who came* licenses internal approximative *almost*. In *hardly anyone present*, *hardly* is peripheral to NP and the restrictor *present* is internal to Nom.
...
Nom_h → (Mod_pre)  F:DP_h  (Comp)  Mods_post
F∈{Det–Head,Mod–Head}
```
...
> Note 27. *Both*, *either*, and *neither* also serve as markers of coordination (Huddleston and Pullum 2002, 1305, 1308). Their noun categorization would preserve that further category–function combination; the present fragment doesn’t analyse coordination.
...
> Note 31. Payne et al. (2013, 797–98) analyse anaphoric *one* as a common count noun, distinct from determinative *one* and personal pronoun *one*.
