...
baseline = (base / 'notes/snapshots/2026-09-11-final-author-review/determinatives-as-nouns.tex').read_text()
baseline = baseline.replace(r'\mathrm{NP}_{h} &\to (\mathrm{Det})', r'\mathrm{NP}_{h} &\to (\mathrm{Mod}_{\mathrm{periph}})\quad (\mathrm{Det})')
...
out = base/'notes/determinatives-as-nouns-review-2026-09-11-final-author.md'
