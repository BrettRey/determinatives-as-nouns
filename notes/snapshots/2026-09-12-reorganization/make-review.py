...
baseline = (base / 'notes/snapshots/2026-09-12-reorganization/determinatives-as-nouns.tex').read_text()
...
out = base/'notes/determinatives-as-nouns-review-2026-09-12-reorganization.md'
