...
Figure~\ref{fig:some} compares \textit{CGEL} with the D-noun analysis for \mention{take some apples} and \mention{take some}. Both keep \mention{some} in one lexical category. In \textit{CGEL}, independent \mention{some} jointly fills determiner and head functions, a \term{fusion of functions} \citep[410--412]{huddleston2002}. In the D-noun analysis, \mention{some} heads its own NP through a Nom in both uses; that NP functions as determiner before \mention{apples} and as object in \mention{take some}.
...
Predication, interrogative clause structure, and modification outside NP structure also fall outside its scope; their implications enter the broader comparison in §\ref{sec:costs}.
