...
old_review = (base / 'notes/determinatives-as-nouns-review-2026-09-10-trimmed.md').read_text()
baseline = (base / 'notes/snapshots/2026-09-11-targeted-revision/determinatives-as-nouns.tex').read_text()
...
out = base/'notes/determinatives-as-nouns-review-2026-09-11-targeted.md'
