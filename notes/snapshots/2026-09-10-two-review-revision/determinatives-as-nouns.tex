...
Reducing fusion's applications can simplify this description even when fusion remains available for adjectives. The advantage is the uniform treatment of \mention{few}; its value depends on any additional conditions or lost generalizations elsewhere.\footnote{Compare \textcite[11--12]{lipseylancaster1956secondbest}'s theory of second best: when a constraint prevents attaining a first-best optimum, satisfying more of the remaining optimality conditions needn't improve the outcome. The analogy concerns interactions among grammatical choices, through which a local simplification may incur costs elsewhere.} Section~\ref{sec:fragment} compares those costs while holding the lexical restrictions fixed.
...
Number supplies a further distinction between determinatives and adjectives. Independent \mention{this}/\allowbreak\mention{these} and \mention{that}/\allowbreak\mention{those} retain their singular--plural contrasts; \mention{each} and \mention{several} have singular and plural specifications respectively. By contrast, the human-class \mention{the rich} is a plural NP whose head lacks plural inflection and still takes adverb modifiers, as in \mention{the very rich} \citep[418]{huddleston2002}. The NP has number even though its adjective has no nominal number paradigm. Determinatives needn't all have contrasting forms or fixed number: \mention{some} permits plural and non-count uses.

Bare colour expressions complicate the comparison. \textit{CGEL} gives \mention{Henrietta likes red shirts, and I like blue}, with \mention{blue} understood as blue shirts \citep[417]{huddleston2002}. The form permits both noun and adjective analyses, and coordination supplies a possible source of reduction. The bare age and size examples with \mention{old} and \mention{small} on the same page also occur in coordinated contrasts. These examples require analysis beyond the absence of an overt \mention{shirts} or \mention{dogs}.

Comparative \mention{bluer} distinguishes the adjectival form from the colour noun. A more controlled test compares constructed \mention{I'll take these} with \mention{I'll take bluer}, referring to shirts visible in the situation. The latter needs an acceptability judgment under that interpretation. \mention{I'll take the bluer of the two} belongs to the established externally determined comparative construction; replacing \mention{blue} with \mention{bluer} inside the original coordination would still leave the contribution of that construction to assess.

An independently attested evaluative subject is \mention{Bluer is better}, accompanying a colour scale for results.\footnote{Stanford CS329X, \href{https://web.stanford.edu/class/cs329x/slides/Lecture12_B_Codeswitching\%20LLMs.pdf}{\enquote{Codeswitching LLMs}}, slide~8; accessed 10 September 2026.} I take this to evaluate a greater degree of blueness. Subject function alone doesn't establish NP status: clauses and, under restricted conditions, other phrase categories also function as subjects \citep[236]{huddleston2002}. Its phrase category remains open. The attestation establishes a bare comparative subject, but doesn't establish the ordinary argument distribution or number behaviour of independent determinatives.
