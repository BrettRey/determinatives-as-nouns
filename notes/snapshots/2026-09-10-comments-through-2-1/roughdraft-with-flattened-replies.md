...
Current revision following the two supplied reviews. Trees and schemata are shown as text; footnotes appear beside their paragraphs. The LaTeX source remains the manuscript master. [Typeset PDF](../determinatives-as-nouns.pdf).
# Abstract
I argue that English determinatives belong within Noun, provisionally as a fourth coordinate subcategory alongside common nouns, proper nouns and pronouns. The argument extends the grounds on which _The Cambridge grammar of the English language_ already includes pronouns despite their distinctive inflection and restricted dependents. Independent uses, number, genitives, partitives and modification support a shared nominal profile. A matched grammatical fragment separates this membership argument from the further proposal of ordinary headedness. The taxonomic choice concerns inheritance through Noun versus projection across separate noun and determinative categories, with lexical and constructional restrictions preserved, including those of articles.
...
I adopt the general framework of _The Cambridge grammar of the English language_ (_CGEL_; Huddleston and Pullum (2002)). Unlike _CGEL_, {++though,++}{id="s1" by="user" at="2026-09-10T12:48:42.473Z"} I include determinatives within Noun. The claims concern synchronic English lexical categories.

I use determinative for the category containing articles, demonstratives and quantifiers such as _the_, _this_, _some_, _every_ and _many_. I reserve determiner for a syntactic function within the noun phrase. This distinction separates what kind of word _some_ is from what {~~its~>syntactic relationships it~~}{id="s2" by="user" at="2026-09-10T12:49:22.796Z"} phrase {~~does~>participates in~~}{id="s3" by="user" at="2026-09-10T12:49:31.799Z"}. Capitalized Noun names the proposed superordinate category containing common nouns, proper nouns, pronouns and determinative nouns.
...
_CGEL_ already places common nouns, proper nouns and pronouns within Noun. It expressly justifies pronoun membership by the functions of pronoun-headed phrases, despite differences in inflection and dependents (Huddleston and Pullum 2002, 327–28). The question {++here++}{id="s4" by="user" at="2026-09-10T12:50:01.895Z"} is whether determinatives meet comparable grounds for inclusion. Differences from common nouns alone can’t settle that question: the accepted noun subcategories already differ from one another. The inclusion of auxiliaries within Verb supplies a precedent for this kind of extension: a closed category can retain its distinctive syntax within a broader lexical category (Pullum and Wilson 1977).

> Note 2. {==The inflectional parallel is limited. Non-modal auxiliaries share verbal tense and agreement contrasts, as in _have/has/had_; nominal number inflection within determinative is concentrated in the demonstratives (§4.4). The precedent supports the taxonomic move, while the nominal evidence must justify this application.==}{>>is this needed? Consider that must is completely defective.<<}{id="c1" by="user" at="2026-09-10T12:51:01.843Z"}

Inclusion within Noun is the principal thesis. The placement of determinative alongside pronoun and {==the analysis of independent determinatives as ordinary heads are further proposals==}{>>I'm also not sure why we would take this approach. At worst, I'd say, this assumption simply follows from Inclusion within Noun.<<}{id="c2" by="user" at="2026-09-10T12:53:13.403Z"}, assessed separately in §§5 and 7.2.

{==Figure 1==}{>>in the figure, the edge from head:Nom to Det–Head:DP is thicker. Make all the head edges like this in all diagrams<<}{id="c3" by="user" at="2026-09-10T12:54:32.902Z"} compares _CGEL_ with the ordinary-Head variant of the D-noun analysis for _take some apples_ and _take some_. Both keep _some_ in one lexical category across uses. In _CGEL_, independent _some_ jointly fills determiner and head functions, a fusion of functions (Huddleston and Pullum 2002, 410–12). In the ordinary-Head variant, _some_ always heads its own NP through a nominal (Nom): the phrase level below NP, containing the head and internal dependents but excluding an external determiner.

Here DP abbreviates determinative phrase, as in _CGEL_. It differs from the DP of the DP hypothesis, where D heads the whole expression _some apples_ (Abney 1987). The D-noun analysis keeps _apples_ as that expression’s ultimate head.
...
Figure 1: _Take some apples_ (first and third trees) and _take some_ (second and fourth trees) under _CGEL_ (first pair) and the ordinary-Head variant of the D-noun analysis (second pair). In the second tree, DP fills Det of NP and Head of Nom. In the third and fourth trees, _some_ heads an NP through the same nominal projection; that NP functions as Det in the third tree and Obj in the fourth tree. Function labels appear above category labels. Det marks determiner, Obj object, and Det–Head fusion; the two links show the combined functions. N, D and V mark noun, determinative and verb; NP, DP and VP mark their phrases. Subscripts identify noun subcategories.

Earlier unifications include Palmer’s grouping of determinatives with pronouns {++(contra the establish adjective analysis)++}{id="s5" by="user" at="2026-09-10T12:58:04.465Z"}, Postal’s underlying article analysis of pronouns, and Sommerstein’s underlying NP analysis of articles and pronouns (Palmer 1924; Postal 1966; Sommerstein 1972). Hudson places the words he calls determiners within pronoun and pronoun within noun (Hudson 2004, 2010). Section 2.2 compares these proposals; Table 1 locates the taxonomic alternatives.
...
Lexical categories and syntactic functions cut across one another. An NP can function as determiner, as in {==_Kim’s_==}{>>underline Kim's<<}{id="c4" by="user" at="2026-09-10T12:59:35.854Z"} _book_, and a determinative-headed phrase can function as modifier, as in _the_ {==_many_==}{>><<}{id="c5" by="user" at="2026-09-10T12:59:48.864Z"} _people_ (Payne et al. 2010; Pullum and Miller 2022). Including determinatives within Noun preserves this distinction: the NP headed by _some_ functions as determiner in _take some apples_ and as object in _take some_ (Figure 1).

Two questions about headedness also need separating. {==Bruening (2020)==}{>>Miller and Pullum do the same for non-generativists<<}{id="c6" by="user" at="2026-09-10T13:05:17.556Z"} supplies a generative defence of N-headed rather than D-headed nominals, drawing on selection and conventionalized expressions. Such arguments concern the head of expressions such as _some apples_; they don’t by themselves assign determinatives to Noun. {==Whether independent _some_ has ordinary Head or a fused function is a further question.==}{>>As I said above, this just seems to follow. It strikes me a highly contrary to say that they're nouns but not normal heads of NPs unless those NPs function as determiers. Consider figure 1 Ordinary-Head variant of the D-noun analysis. Are you suggesting that the 3-level tree of some on the left would co-exist with the 3.5 level tree in the CGEL right?<<}{id="c7" by="user" at="2026-09-10T13:09:54.437Z"} Including determinatives within Noun leaves both available (§7.2). {++I'd rewrite this paragraph something like this:++}{id="s6" by="user" at="2026-09-10T13:14:02.052Z"}

{++This is a distinct question from that most commonly associated with Abney (xxxx) and the so-called DP-hypothesis. I take that position to be in error (see Miller and Pullum (xxxx); see Bruening (2020) for the generative-internal rejection).++}{id="s7" by="user" at="2026-09-10T13:14:17.690Z"}

Category membership doesn’t remove lexical restrictions either. _Every apple_ is grammatical, but *_I’ll take every_ isn’t an ordinary way to accept apples. Making _every_ a noun doesn’t give it the full range of uses available to _some_. Section 7.2 states structural rules and lexical restrictions separately so their contributions can be assessed.
...
Anderson (1997) draws the boundary of the nominal category differently. He groups names, pronouns and determining words as a notional {N} category, with common nouns represented separately. His {N} differs from the inclusive Noun proposed here and falls outside Table 1.

Taxonomic inclusion doesn’t settle the structural analysis. Hudson separates dependency from phrase headedness: his 2004 account permits mutual dependency between determiner and common noun, with different constructions selecting different external heads (Hudson 2004, 7–9). In _We met that day_, the temporal adjunct depends on the temporal meaning of _day_. Such restrictions support a common-noun head for temporal adjuncts (Hudson 2004, 10–12).

Other unifications concern underlying representation. Postal (1966) unifies personal pronouns and articles through an underlying article analysis. Sommerstein (1972, 197–203) reverses the direction, assigning underlying NP structure to the definite article and personal pronouns, with relative-clause structures contributing further descriptive material. These structures don’t by themselves place the surface lexical categories in Table 1. Déchaine and Wiltschko (2002) distinguish pro-DP, pro-φP and pro-NP, connecting different pronominal projections with distribution and binding. Their proposal adds differences in pronominal projection to the comparison.
...
Independent nominal use may support inclusion within Noun without selecting the pronoun subcategory. The demonstratives’ deictic properties make a pronominal grouping plausible; the question is how far that grouping captures the wider inventory’s syntax. The comparisons below address modifier profiles (§3.3), the determinative–pronoun boundary (§5), and the positive connections linking restricted _every_ to other quantifiers (§6). Redistribution must be assessed against those connections as well as independence. The starting point is _CGEL_’s existing grounds for including distinct subcategories within Noun.
...
| Internal modification | Productive AdjP and nominal modification | Restricted embellishments | Restricted: _poor old me_ | Restricted adverb premodifiers and nominal postmodifiers |
...
Determiner function already cuts across the existing noun subcategories. Compare _my book_, _Kim’s book_ and _the king’s book_. The determiner is an NP ultimately headed by a pronoun, a proper noun and a common noun respectively (Huddleston and Pullum 2002, 354–55, 470–71). In the last example, _the_ determines _king_ inside the genitive NP, while that whole NP determines _book_. Figure 2 illustrates the proper-noun case: _Kim’s_ fills Det, while _book_ ultimately heads the larger NP.

> Note 3. _CGEL_ assigns these genitives the combined function Subject–Det (Huddleston and Pullum 2002, 472–73). I treat them as Det here, without the additional subject function. Their determining role supplies the relevant comparison; accepting the further subject analysis would leave the nounhood argument intact.
...
The compound determinative joins this pattern in _someone’s book_: its genitive NP fills the same determiner function. This completes a four-way comparison within the genitive construction, rather than merely placing _some apples_ beside _Kim’s book_. The nominal base in _someone_ may contribute to that permission; it doesn’t establish genitive marking throughout determinative. It does supply a positive connection between a determinative compound and the existing noun subcategories.
...
> Note 5. CGELBank (Reynolds et al. 2023), sentence `reviews-083459-0002`.
...
Figure 4 gives the ordinary-Head D-noun analysis, with the _of_-phrase functioning as complement within Nom, as in _CGEL_’s partitive tree (Huddleston and Pullum 2002, 411–12). _CGEL_ represents the head-like role of _some_ through Det–Head fusion. Partitives support that role while leaving the choice between fusion and ordinary headedness open.
...
Figure 4: _Some of the wine_ under the ordinary-Head D-noun analysis. The Head relations lead from the outer NP to _some_. The common noun _wine_ is inside the complement PP and doesn’t head the whole expression. The inner NP is abbreviated.
...
The ordinary-Head analysis treats _some_ and _some of the wine_ as sharing nominal projection, with an added domain phrase in the partitive. Modification provides a further comparison of internal structure.
...
> Note 6. Compare the theory of second best in Lipsey and Lancaster (1956, 11–12): under a constraint preventing an optimum, satisfying more optimality conditions needn’t improve the outcome. The analogy concerns interactions among grammatical choices, not a formal optimum for the grammar.
...
> Note 8. Sentence `answers-20111024111513AAAQhAO_ans-0003` in `ewt-test_iaa50.cgel`.
...
The next two sections consider the hierarchy within Noun and the membership of its restricted forms. Section 7.2 then compares the grammatical organization under each taxonomy and headedness choice.
...
I retain the coordinate classification as a provisional organizational preference. It preserves _CGEL_’s determinative/pronoun distinction while extending nominal structure across both. Hudson’s intermediate category would be preferable if further syntactic generalizations over the aligned inventory reduced otherwise repeated restrictions. Section 6 turns from the position of determinative within Noun to the membership of its restricted forms.
...
> Note 10. The restriction concerns ordinary argument use. In _the bigger the better_, _CGEL_ analyses _the_ as a modifier within a comparative phrase (Huddleston and Pullum 2002, 1131–32, 1135–36). This dependent use outside Det leaves the restriction on ordinary argument use intact.
...
Table 5 locates the four accounts. The ordinary-Head accounts differ in the categories admitted to nominal projection; the fusion accounts differ in the category of the phrase realizing the fused functions.

Table 5: Taxonomy and headedness varied separately. All four accounts retain the permissions in Table 4, the modifier restrictions and the compound conditions.
...
comments: c8: body: |- I recommend deleting this footnote. The auxiliary precedent concerns inclusion of a distinctive subcategory, and the body already says that. Must makes the point that an ordinary verbal inflectional paradigm is not required of every verb: CGEL p. 75 records its lack of a preterite and the modals' lack of secondary forms. “Completely defective” would be too strong if it meant no morphological contrasts at all, since CGEL also recognizes negative mustn't. That qualification needn't enter the paper. The nominal evidence still has to support this particular extension, but that is what the subsequent sections do. by: Codex at: "2026-09-10T13:30:43.775Z" re: c1 c9: body: |- I agree within the grammar this paper proposes. Once determinative is a subtype of Noun, the existing Noun–Nom–NP projection rules apply to it. Ordinary headedness is then inherited; treating it as an additional, comparably optional proposal misstates the analysis. The bridge is category inclusion plus the existing projection rules, with no construction-specific override. Category membership alone would not logically prohibit every fusion analysis, but that logical possibility needn't divide your proposal into variants.

```
  Suggested replacement: “In the D-noun analysis, determinatives inherit the nominal projection rules of Noun. In independent uses such as Some left, the determinative heads a Nom that heads an NP. Lexical restrictions still govern which uses are available. The placement of determinative alongside pronoun is a further proposal, assessed in §5.”
by: Codex
at: "2026-09-10T13:30:43.775Z"
re: c2
```

c10: body: |- Applied in the LaTeX source: all 35 ordinary Head edges now use the same 1 pt width as the three existing fused Head links. The other link in each fusion remains the dependent-function link. The tree structures and labels are unchanged. by: Codex at: "2026-09-10T13:30:43.775Z" re: c3 c11: body: |- Applied: Kim's is underlined within the italicized example in the LaTeX source. by: Codex at: "2026-09-10T13:30:43.775Z" re: c4 c12: body: |- This comment is empty; I have interpreted its parallel placement as a request to underline many too, and applied that formatting in the LaTeX source. by: Codex at: "2026-09-10T13:30:43.775Z" re: c5 c13: body: |- Yes: Pullum and Miller belong in this paragraph. Their argument explicitly separates lexical category, syntactic function and the headedness of the larger nominal. The existing reference is the English 2022 paper, whose author order is Pullum and Miller; the French 2022 paper has Miller and Pullum. I would avoid labelling the English paper non-generativist, since it allows generative grammars with dependency as well as phrase structure. The intended contrast is well served by citing their broader headedness argument alongside Bruening's rejection within a generative analysis. by: Codex at: "2026-09-10T13:30:43.775Z" re: c6 c14: body: |- The fourth account in §7.2 does permit the analogue of the asymmetry you identify. It combines ordinary nominal projection inside the determining phrase with an additional fused structure for independent use. It cannot simply splice the two displayed trees together while following the fragment's own rules: the nominal-D version replaces the fused DP with an NP headed by a determinative noun, so the extra outer structure surrounds an already projected NP. This is formally constructible, but the paper supplies no independent reason to require it for simple some. It should not be presented as a coequal variant of the proposed analysis.

```
  I recommend three main comparisons in §7.2: the D-noun analysis with inherited nominal projection; separate D with ordinary projection licensed across N and D; and CGEL's separate D with fusion. Nominal D with fusion can be acknowledged briefly as a logical possibility if needed. This preserves the useful control from the four-account comparison: ordinary headedness and shared phrase structure are also available to the strongest separate-D rival. The argument for Noun therefore still needs the pronoun inclusion rationale and the wider nominal profile.
  
  The changes propagate to the abstract, the statement of the proposal and Figure 1 labels, §§3.1–3.2, the cumulative argument in §4.7, the comparison in §7.2, and the conclusion. Replace “ordinary-Head variant” and “further proposal” with a single D-noun analysis and its inherited projection. Keep the actual fusion comparisons in §4: they explain the rival and test what the proposed structure gains or has to restate. Keep the lexical restrictions in §§6–7 and the provisional status of coordinate placement in §5. The Head rules don't automatically grant every noun every use permission.
by: Codex
at: "2026-09-10T13:30:43.775Z"
re: c7
```

c15: body: |- The relational wording is more precise. Taken together, s2 and s3 need a small grammatical repair: “This distinction separates what kind of word some is from what syntactic relationships its phrase participates in.” The additions though (s1) and here (s4) also fit the paragraph. These prose edits remain proposals while the larger reframing is under review. by: Codex at: "2026-09-10T13:30:43.775Z" re: s2 c16: body: |- The historical contrast is supported. Palmer p. 24, §40 explicitly discusses the traditional division into qualitative and determinative adjectives, then groups the latter with pronouns. He also reports divergent classifications, so I recommend “against the traditional adjectival classification” rather than implying an uncontested established analysis. This also repairs establish to established if your original wording is retained. by: Codex at: "2026-09-10T13:30:43.775Z" re: s5 c17: body: |- I recommend your change in emphasis, with the scope specified as English and the existing verified references substituted for the placeholders:

```
  “The question of lexical classification is distinct from the headedness question associated with Abney's (1987) DP hypothesis. Under that hypothesis, D heads expressions such as some apples. I retain noun-headed NPs and reject the DP analysis for English, following the arguments of Pullum and Miller (2022) and Bruening (2020).”
  
  The distinction remains necessary: rejecting the DP hypothesis does not itself put determinatives within Noun. But the paragraph can state your position directly without reopening ordinary Head versus fusion as two versions of your proposal.
by: Codex
at: "2026-09-10T13:30:43.775Z"
re: s7
```

c18: body: |- The April genitive passages require a separate correction to my earlier assessment. In the April 29 source, §4.1 presents independent mine, yours and ours as ordinary heads, but attributes that analysis to CGEL. The next paragraph invokes CGEL's fused genitives to establish compatibility with nounhood. These passages do not establish a consistent commitment to retaining genitive fusion in your own grammar.

```
  CGEL's actual distinction is between anaphoric mine referring to a possessed entity (Det–Head) and predicative possessive mine in it's mine (pure Head), pp. 410–411. Correcting the April attribution did not warrant silently adopting CGEL's anaphoric analysis as yours. The September claims that fusion is already needed for genitives (§4.7) and remains available (§7.1) therefore need attention. I recommend keeping CGEL's genitive analysis explicitly attributed as a comparison, and removing any unargued commitment to retaining it in the D-noun proposal. A consistent ordinary-Head analysis of independent genitives would require an explicit statement of your own position; it should not be smuggled in as a claim about CGEL either.
by: Codex
at: "2026-09-10T13:30:43.775Z"
re: c7
```
