...
baseline = (base / 'notes/snapshots/2026-09-11-complete-revision/determinatives-as-nouns.tex').read_text()
...
md = re.sub(r'(?m)^(#{1,3} [^\n]+)\n(?!\n)', r'\1\n\n', md)
md = re.sub(r'\n{3,}', '\n\n', md)
header = '# Determinatives as nouns in English\n\nBrett Reynolds — 11 September 2026 working draft\n\nComplete revision following your annotations and the question about *what*. Trees and schemata are shown as text; footnotes appear beside their paragraphs. [Typeset PDF](../determinatives-as-nouns.pdf) · [Response to all review points](passes/2026-09-11-complete-revision.md).\n\n'
out = base/'notes/determinatives-as-nouns-review-2026-09-11-complete.md'
