...
_CGEL_ already includes pronouns within the superordinate Noun category, along with common and proper nouns, on the basis of their phrases’ functions, despite differences in inflection and dependents (Huddleston and Pullum 2002, 327–28). The inclusion of auxiliaries within Verb supplies a further precedent for preserving distinctive {~~syntax~>properties~~}{id="s1" by="user" at="2026-09-11T13:22:24.235Z"} within a broader lexical category (Pullum and Wilson 1977).
...
The English article–pronoun boundary has long been contested. Palmer (1924) groups “determinative adjectives” with pronouns; Postal (1966) analyses personal pronouns as articles at an intermediate level of representation; Sommerstein (1972) gives the definite article and pronouns underlying NP structure. Hudson places his determining words within pronoun and pronoun within noun (Hudson 2004, 2010){==.==}{>><<}{id="c1" by="user" at="2026-09-11T13:23:49.343Z"}

{==Ordinary==}{>>the flow between paragraphs seems disrupted. It could be much smoother.<<}{id="c2" by="user" at="2026-09-11T13:23:55.568Z"} Head structure {++in NPs++}{id="s2" by="user" at="2026-09-11T13:25:00.720Z"} unifies the bare {++(I have some)++}{id="s4" by="user" at="2026-09-11T13:25:25.742Z"}, partitive {++(some of the),++}{id="s3" by="user" at="2026-09-11T13:25:11.717Z"} and externally determined {++(some books [is this right?])++}{id="s5" by="user" at="2026-09-11T13:25:41.266Z"} uses that _CGEL_ divides between Det–Head and Mod–Head fusion. Replacing DP with NP also {++consolidates the set of phrase types functioning as determiner.++}{id="s6" by="user" at="2026-09-11T13:26:43.563Z"} {--shares a phrase type across determinatives, genitives and minor nominal determiners. A separate-D grammar can share these structures.--}{id="s7" by="user" at="2026-09-11T13:35:10.169Z"} Including determinatives within Noun makes nominal projection inherited and brings the determinative, common-noun and proper-noun uses of cardinals within one primary category{==.==}{>>the paragraph needs a rework<<}{id="c3" by="user" at="2026-09-11T14:04:48.750Z"}
...
| {==External syntax==}{>>consider my additions extra carefully here<<}{id="c9" by="user" at="2026-09-11T15:32:13.330Z"} | NP argument functions; genitive Det{++; mod; adjunct++}{id="s18" by="user" at="2026-09-11T15:31:42.206Z"} | NP argument functions; genitive Det{++; mod; adjunct++}{id="s19" by="user" at="2026-09-11T15:31:58.821Z"} | NP argument functions; genitive Det{++; interrogative, relative, and exclamative; mod; adjunct++}{id="s11" by="user" at="2026-09-11T15:22:16.917Z"} | NP argument functions; Det {++(incl genitive Det)++}{id="s14" by="user" at="2026-09-11T15:23:14.139Z"}{--as in _some books_, _someone’s books_--}{id="s13" by="user" at="2026-09-11T15:23:03.744Z"}{++; interrogative, relative, and exclamative; mod; adjunct++}{id="s12" by="user" at="2026-09-11T15:22:40.716Z"} |
| Meaning | Descriptive properties and relations | Naming in primary uses | Mainly deixis and anaphora{++; interrogation++}{id="s15" by="user" at="2026-09-11T15:23:42.632Z"} | Quantification, definiteness and deixis{++; interrogation++}{id="s16" by="user" at="2026-09-11T15:23:52.826Z"} |
...
| {==Noun-forming suffixes==}{>>this seems incomplete and ad hoc<<}{id="c8" by="user" at="2026-09-11T15:29:03.842Z"} | _-ship_: _friendship_ | _-er_: _Londoner_ | No parallel established here | _-ness_: _nothingness_ |
| {++Accepts++}{id="s17" by="user" at="2026-09-11T15:30:58.111Z"} Determination | Broad contrasts; singular count arguments normally require it | Restricted in primary naming uses | Normally excluded | Lexically restricted; _the few_, _these three_ |
| Internal modification | Productive; usually AdjP premodifiers; relative postmodifiers | Restricted {++AdjP premodifiers;++}{id="s20" by="user" at="2026-09-11T15:32:53.835Z"} embellishments | Restricted {++AdjP premodifiers++}{id="s22" by="user" at="2026-09-11T15:33:17.068Z"}{--: _poor old me_--}{id="s21" by="user" at="2026-09-11T15:33:01.897Z"}; relative postmodifiers | {++D &++}{id="s23" by="user" at="2026-09-11T15:33:42.869Z"} AdvP premodifiers; NP-internal postmodifiers; _the lucky few_ |
...
Meaning and reference vary within Noun. _Apple_ conveys a descriptive classification; _Kim_, in its primary naming use, identifies through a name; _she_ supplies limited descriptive content and depends on context. Determinatives range from deictic _this_ to quantitative _many_ and universal _every_ (Huddleston and Pullum 2002, 358–60, 370–405, 425–28, 515–21). Their semantic affinities cross several boundaries: deixis connects demonstratives with pronouns {++and some adjectives (_proximate_, _distal_)++}{id="s25" by="user" at="2026-09-11T15:47:33.992Z"}, while quantity connects determinatives with {++a few++}{id="s26" by="user" at="2026-09-11T15:48:12.032Z"} common nouns such as _number_ and _majority_ {++and adjectives such as _singular_ and _plural_++}{id="s24" by="user" at="2026-09-11T15:46:51.890Z"}.

Pro-form gender {++(Reynolds 2025)++}{id="s28" by="user" at="2026-09-11T15:48:45.477Z"} connects these ways of referring. Descriptions such as _the woman_ and names such as _Kim_ identify referents whose construal bears on pro-form choice. Gender-sensitive pronouns and determinatives express the relevant contrasts: compare personal _she_ and _somebody_ with non-personal _it_ and _something_ {++or _who_ and _which_++}{id="s29" by="user" at="2026-09-11T15:49:15.893Z"} {--(Reynolds 2025)--}{id="s27" by="user" at="2026-09-11T15:48:42.116Z"}.
...
External syntax supplies a broad overlap in the functions available to the phrases. _CGEL_ makes this the stated ground for including pronouns within Noun (Huddleston and Pullum 2002, 327). A range of determinatives likewise occurs in subject, object and complement-of-preposition positions without another overt nominal head. The examples in §4.1 compare these uses across all four proposed subcategories. {++Phrases headed by all four putative noun subcategories also function as modifiers (**_dog_** _houses_, **_Canada_** _day_, _the_ **_me_** _generation_, _the_ **_few_** _people_)++}{id="s30" by="user" at="2026-09-11T15:50:50.521Z"}

Shared functions leave systematic distributional differences. In _W_{++_hat a nice day_++}{id="s32" by="user" at="2026-09-11T15:56:32.088Z"}{--_ho did you see?_--}{id="s31" by="user" at="2026-09-11T15:56:29.799Z"}, {~~interrogative~>exclamative~~}{id="s33" by="user" at="2026-09-11T15:57:10.995Z"} _wh_{++_at_++}{id="s34" by="user" at="2026-09-11T15:57:14.958Z"}{--_o_--}{id="s35" by="user" at="2026-09-11T15:57:18.708Z"} precedes the {~~inverted auxiliary~>NP~~}{id="s36" by="user" at="2026-09-11T15:57:25.505Z"}. {--Substituting _the vicar_ doesn’t preserve the open interrogative. A common-noun-headed phrase needs an interrogative constituent, as in _which vicar_. Both expressions have object function, but the construction also requires interrogative properties (Huddleston and Pullum 2002, Ch. 10, §§7.1, 7.9).--}{id="s37" by="user" at="2026-09-11T15:57:49.268Z"} {++No common or proper NP can substitute for _what_, which _CGEL_ takes to be a pronoun.++}{id="s38" by="user" at="2026-09-11T15:58:03.383Z"}

{~~Adjectival constructions~>AdjPs~~}{id="s39" by="user" at="2026-09-11T15:59:17.090Z"} {--such as _the_ **_rich_**--}{id="s41" by="user" at="2026-09-11T16:00:26.524Z"} also {~~fill nominal argument positions~>overlap in distribution with NPs (e.g., _the_ **_people_**/**_rich_**, a soccer/round ball, and Jones became president/ill)~~}{id="s40" by="user" at="2026-09-11T16:00:08.433Z"}, so external functions alone don’t establish nounhood. Internal syntax extends the comparison: {++common nouns and++}{id="s43" by="user" at="2026-09-11T16:03:56.371Z"} determinatives permit partitive complements, as in {++_a bottle_/++}{id="s42" by="user" at="2026-09-11T16:02:43.468Z"}_some of the wine_, {~~and~>but~~}{id="s44" by="user" at="2026-09-11T16:04:12.522Z"} comparative complements, as in _more than ten_{++, aren't shared++}{id="s45" by="user" at="2026-09-11T16:04:19.562Z"} (Huddleston and Pullum 2002, 392–94, 411–12, 432–33).

Common nouns permit PP{--s--}{id="s46" by="user" at="2026-09-11T16:05:12.628Z"} and claus{++al++}{id="s48" by="user" at="2026-09-11T16:05:16.948Z"}{--es--}{id="s47" by="user" at="2026-09-11T16:05:15.730Z"} {++complements++}{id="s49" by="user" at="2026-09-11T16:05:18.521Z"}, while pronouns and primary naming uses of proper nouns have much more restricted dependents (Huddleston and Pullum 2002, 429–30, 439–43, 517–21). Determinatives share parts of both profiles: restricted determination and modification coexist with nominal complement and postmodifier constructions. Section 3.3 examines their distinctive premodifiers, and §4.4 compares the resulting profile with adjectives.
...
Noun-forming suffixes differ in the bases they select. _-ship_ in _friendship_ primarily selects nouns denoting persons, though _hardship_ has an adjective base. The inhabitant suffix _-er_ in _Londoner_ attaches to a place name (Huddleston and Pullum 2002, Ch. 19, §§5.6.2(b), 5.7.2(k)). Table 2 establishes no noun-selecting suffix shared by pronouns and determinatives.
...
_CGEL_ also uses fusion with nouns. It assigns anaphoric _mine_ to Det–Head, but predicative possessive _mine_, as in _it’s mine_, to pure Head (Huddleston and Pullum 2002, 410–11). Nounhood is thus compatible with fusion. Here ordinary determinative headedness follows from the inherited projection rules; the analysis of independent genitives, including _Kim’s_ and _mine_, falls outside the fragment in §7.2.
