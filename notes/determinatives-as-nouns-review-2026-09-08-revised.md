...
comments:
  ...
  c7:
    body: "Replaced Table 1 with the two CGEL trees alongside the existing D-noun trees in Figure 1. The CGEL fusion tree shows both the Det link to NP and the Head link to Nom, following CGEL p. 412."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c1
  c8:
    body: "Removed the repeated setup from §2.1. The comparison is now introduced once around Figure 1."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c2
  c9:
    body: "Removed the repeated projection explanation, almost every example and notation paragraph here. The opening figure introduces the notation; the full modification example remains in §3.4."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c3
  c10:
    body: "Collected the fuller Palmer, Postal, Sommerstein and Hudson discussions in §2.2, Related analyses. The introduction now mentions all four together. Déchaine and Wiltschko and Lyons have moved with the related discussion."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c4
  c11:
    body: "Rebuilt §2.1 as Category and phrase structure: category versus function, nounhood versus headedness, then the lexical restrictions illustrated by every. The comparison table and repeated definitions are gone."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c5
  c12:
    body: "Applied the comments through §2.1, with the associated moves into §2.2 and reference updates. The fresh review copy is determinatives-as-nouns-review-2026-09-09.md."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: c6
  c13:
    body: "Verified your quotation against Palmer’s original p. 24 and retained it verbatim in the collected discussion in §2.2. Removed the Reynolds 2013 reproduction sentence as requested."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: s20
  c14:
    body: "Postal and Sommerstein are now named in the introductory comparison, and discussed alongside the other unifications in §2.2."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: s23
  c15:
    body: "Adopted the explicit CGEL framework statement and your contrast between fusion and ordinary NP headedness. Moved the framework statement before the trees, retained four coordinate subcategories of Noun, moved the auxiliary precedent to follow the pronoun argument, and adopted the DP-hypothesis contrast and modifier label."
    by: Codex
    at: "2026-09-10T00:01:04.274Z"
    re: s1
