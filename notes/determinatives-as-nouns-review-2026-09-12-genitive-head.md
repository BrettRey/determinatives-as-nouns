...
Revised to give mine ordinary Head in both anaphoric and predicative uses, consistently with independent few. Figure 6 includes the corrected NP layer. Trees and schemata are shown as text; footnotes appear beside their paragraphs. [Typeset PDF](../determinatives-as-nouns.pdf) · [Response to all review points](passes/2026-09-12-genitive-head.md).
